...
filename = 'weights_training.pth'
pretrained_filename = 'weights_pretraining.pth'
pretrained_segmentation_branch = 'weights_pretrained_segmentation_branch.pth'

# Training Parameters
start_from_pretrained = True
use_pretrained_segmentation_branch = True
num_training_epochs = 100
batch_size = 10
# starting_lr = 8e-6  # For Adam optimizer
starting_lr = 2e-7  # For SGD
